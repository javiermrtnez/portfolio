      ...
      component: (
        <div className='flex flex-col gap-4 text-[14.5px] text-neutral-400'>
          <p>
            ...
            fermentum turpis ut mauris iaculis, vitae malesuada dui commodo. Nullam id massa sed
            nunc malesuada congue vel vitae nisl. Curabitur iaculis, leo fringilla dignissim
            aliquet, dui quam eleifend eros, eget tincidunt lorem lacus at nulla. Mauris non
            elementum erat. Aenean leo enim, pharetra vitae ipsum vitae, tristique pellentesque leo.
            Vivamus ut pharetra purus.
          </p>
        </div>
      ),
    },
